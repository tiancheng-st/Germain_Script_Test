...
SCOPE_VISA_ADDRESS = "USB0::0x0957::0xBE18::K-86100D-20187::0::INSTR" # Get this from Keysight IO Libraries Connection Expert #Note: sockets are not supported in this revision of the script, and pyVisa 1.6.3 does not support HiSlip
...
# IDN = KsInfiniiVisionX.query("*IDN?")
...
# debug
# rawdata = KsInfiniiVisionX.query_binary_values(":DISPlay:DATA? PNG,SCReen,COLor", datatype='f', container=bytes)
# print(rawdata)
